...
public class Pool : MonoBehaviour
{
    ...
    /// <returns></returns>
    public GameObject SpawnObject(Vector3 position, PoolItemType poolItemType, Transform parent, Quaternion rotation)
    {
        ...
        if (b != null)
        {
            ...
            if (rotation != null) b.transform.rotation = rotation;
            {
            }
            b.SetActive(true);
        }
    ...
    private void Awake()
    {
        ...
        {
            Debug.LogError("Multiple instances of Pool.cs");
            Destroy(gameObject);
        }
    ...
    private void UpdateEnum()
    {
        ...
        const string filePathAndName = "Assets/Development/Scripts/Utilities/PoolItemType.cs";
